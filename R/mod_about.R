...
mod_about_ui <- function(id){
  ...
  fullPage::pageContainer(
    ...
    p(""),
    p(class = "about",
      "A Shiny app created with", emo::ji('coffee'), "and", emo::ji('heart'), "for the CorrelAid X Challenge 2020", 
      br(),
      em("“Analysing and visualising German regional statistics with datenguidepy”"),
      br(),
      "by Andreas Neumann, Cédric Scherer, Saleh Hamed & Steffen Reinhold"),
    br(),
